    ...
    forn(i, 1, n) {
        ...
        if (a[i].x < d.x) {
            if (d.y < a[i].y && a[i].y < u.y) {
                ...
                if (v[i].y < 0) {
                    if ((d.x - a[i].x) * v[i].y == (d.y - a[i].y) * v[i].x) no();
                }
            }
            if (v[i].x <= 0) no();
        ...
        if (a[i].x > u.x) {
            if (d.y < a[i].y && a[i].y < u.y) {
                if (v[i].y > 0) {
                    if ((u.x - a[i].x) * v[i].y == (u.y - a[i].y) * v[i].x) no();
                }
                if (v[i].y < 0) {
            ...
            if (v[i].x >= 0) no();
            l = max(l, (u.x - a[i].x) / ld(v[i].x));
            r = min(r, (d.x - a[i].x) / ld(v[i].x));
        }
        else {
            if (v[i].x != 0) {
                if (v[i].x > 0) {
        ...
        if (a[i].y > u.y) {
            ...
            if (v[i].y >= 0) no();
            l = max(l, (u.y - a[i].y) / ld(v[i].y));
            r = min(r, (d.y - a[i].y) / ld(v[i].y));
        }
        else {
            if (v[i].y != 0) {
                if (v[i].y > 0) {
